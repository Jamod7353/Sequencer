...
const char UNITY_PROGMEM UnityStrOk[]                            = "\033[42mOK\033[00m";
const char UNITY_PROGMEM UnityStrPass[]                          = "\033[42mPASS\033[00m";
const char UNITY_PROGMEM UnityStrFail[]                          = "\033[41mFAIL\033[00m";
const char UNITY_PROGMEM UnityStrIgnore[]                        = "\033[43mIGNORE\033[00m";
#else
...
void UnityAssertEqualMemory(UNITY_INTERNAL_PTR expected,
                            ...
                            const UNITY_FLAGS_T flags)
{
    UNITY_PTR_ATTRIBUTE const char* ptr_exp = (UNITY_PTR_ATTRIBUTE const char*)expected;
    UNITY_PTR_ATTRIBUTE const char* ptr_act = (UNITY_PTR_ATTRIBUTE const char*)actual;
    UNITY_UINT32 elements = num_elements;
    UNITY_UINT32 bytes;
    ...
    while (elements--)
    {
        ...
        {
            ptr_exp = (UNITY_PTR_ATTRIBUTE const char*)expected;
        }
    }
}
