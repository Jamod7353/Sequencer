 ...
 *-------------------------------------------------------*/
    ...
    typedef char   UNITY_UINT8;
    typedef short  UNITY_UINT16;
    typedef int    UNITY_UINT32;
    typedef signed char     UNITY_INT8;
    typedef signed short    UNITY_INT16;
    typedef signed int      UNITY_INT32;
#elif (UNITY_INT_WIDTH == 16)
    typedef char   UNITY_UINT8;
    typedef int    UNITY_UINT16;
    typedef long   UNITY_UINT32;
    typedef signed char     UNITY_INT8;
...
/* 64-Bit Support Dependent Configuration */
  ...
  /* 64-bit Support */
    ...
    typedef long long UNITY_UINT64;
    typedef signed long long   UNITY_INT64;
  #elif (UNITY_LONG_WIDTH == 64)
    typedef long      UNITY_UINT64;
